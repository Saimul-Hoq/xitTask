...
<section>
    ...
    <form id="signup-form" action="/projects/xitTask/" method="post" enctype="multipart/form-data">
        ...
        <div class="signup-btn-area">
            ...
            <button id="signup-register-btn" type="submit" id="signup-register-btn" class="btn signup-btn btn-primary"><h3>Create new account</h3></button>
        </div>
    </form>
    <p id="login" class="text-center">Already have account? <a href="/projects/xitTask/">Sign in</a> </p>
</section>
